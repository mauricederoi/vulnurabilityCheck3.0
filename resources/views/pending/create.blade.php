{{Form::open(array('url'=>'pending','method'=>'post'))}}
    <div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    @if(!empty($permissions))
                        ...
                        <label for="permissions" class="col-form-label">{{__('Department Permission')}}</label>
                                            ...
                                            <div class="row">
                                                @if(in_array('manage '.$module,(array) $permissions))
                                                    @if($key = array_search('manage '.$module,$permissions))
                                                        <div class="col-md-3 form-check">
                                                            {{Form::checkbox('permissions[]',$key,true, ['class'=>'form-check-input isscheck isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])}}
                                                ...
                                                @if(in_array('buy '.$module,(array) $permissions))
                                                    @if($key = array_search('buy '.$module,$permissions))
                                                        <div class="col-md-3 form-check">
                                                            {{Form::checkbox('permissions[] isscheck isscheck_'.str_replace(' ', '', $module),$key,true, ['class'=>'form-check-input','id' =>'permission'.$key])}}
