...
@section('content')
    ...
    <div class="card">
        <div class="row align-items-center" style="justify-content: center;">
            <div class="col-xl-12" style="width: 420px;background: white;border-radius: 25px">
                <div class="card-body">
                    <div class="">
                    ...
                    <div class="">
                        <div class="form-group mb-3">
                            ...
                            {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => __('Enter Your Email'), 'style'=>'border: none;height: 55px;border-radius: 15px']) }}
                            @error('email')
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::password('password', ['class' => 'form-control', 'placeholder' => __('Enter Your Password'), 'id' => 'input-password', 'style'=>'border: none;height: 55px;border-radius: 15px']) }}
