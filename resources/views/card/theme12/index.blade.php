            ...
            <div class="home-wrapper">
                <section class="home-banner-section">
                    <img src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/img/placeholder-image.jpg') }}"
                        id="banner_preview" alt="fs" class="home-banner" style="display: block; border-radius: 0 0 60px 60px;">
						 <div class="overlay" style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;background: rgba(0, 0, 0, 0.5);border-radius: 0 0 60px 60px;"></div>
                </section>
