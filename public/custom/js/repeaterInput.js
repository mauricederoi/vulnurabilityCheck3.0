...
function repeaterInput(element, element_type, rowno, divid, path, theme_type, color, assets) {
	...
	if (element_type == "leadgeneration") {
        var class_radio = '';
        if(radio_count % 2 == 0){
            class_radio = 'radio-left';
        }
    
                html = `<div class="row mb-4" id="inputFormRow5">
                <div class="col-lg-5">
                    <div class="form-group mb-0">
                        <input type="text"  class="form-control" name="leadtitle[${rowno}][title]" placeholder="Campaign Name" id="leadgeneration_title_${rowno}" value="" onchange="changeTime(this.id)">
                    </div>
                </div>

                <div class="col-lg-5">
                    <div class="form-group mb-0">
                        <input type="text" class="form-control" name="leadtitle[${rowno}][btitle]" id="leadgeneration_btitle_${rowno}" placeholder="Botton Title" value="" onchange="changeTime(this.id)">
                    </div>
                </div>
				<div class="col-lg-5 d-none">
                    <div class="form-group mb-0">
                        <input type="text" class="form-control" name="leadtitle[${rowno}][created_at]" id="leadgeneration_created_at_${rowno}" placeholder="Created at" value="" onchange="changeTime(this.id)">
                    </div>
                </div>
                <div class="col-lg-2">
                
                        <a href="javascript:void(0)" class="close-btn leadgeneration_${rowno}" id="removeRow_leadgeneration" data-id="leadgeneration_${rowno}">
                        <svg xmlns="http://www.w3.org/2000/svg"  width="25" height="25" viewBox="0 0 25 25" fill="none">
                            <path
                                opacity="0.4"
                                d="M12.2539 22.6094C17.7768 22.6094 22.2539 18.1322 22.2539 12.6094C22.2539 7.08653 17.7768 2.60938 12.2539 2.60938C6.73106 2.60938 2.25391 7.08653 2.25391 12.6094C2.25391 18.1322 6.73106 22.6094 12.2539 22.6094Z"
        ...
        preview_html = `<div class="radio ${class_radio} " id="leadgeneration_${rowno}">
                        <input id="radio-${radio_count}" name="leadgeneration" type="radio"   class="app_time">
                        <label for="radio-${radio_count}" class="radio-label"><span id="leadgeneration_title_${rowno}_preview">00:00 </span> - <span id="leadgeneration_btitle_${rowno}_preview">00:00</span></label>
						id="leadgeneration_created_at_${rowno}_preview">00:00</span></label>
                </div>`;

        if (theme_type == 'theme16' || theme_type == 'theme18'||theme_type == 'theme15'||theme_type == 'theme19'||theme_type == 'theme20') {
            preview_html = `  <li id="leadgeneration_${rowno}"><span id="leadgeneration_title_${rowno}_preview">00:00</span> - <span id="leadgeneration_btitle_${rowno}_preview">00:00</span><span id="leadgeneration_created_at_${rowno}_preview">00:00</span></li>`;
        }
        if (theme_type == 'theme1' || theme_type == 'theme2' || theme_type == 'theme3'|| theme_type == 'theme4'|| theme_type == 'theme5'|| theme_type == 'theme6'|| theme_type == 'theme7'|| theme_type == 'theme8'|| theme_type == 'theme9'|| theme_type == 'theme10'|| theme_type == 'theme11') {
            preview_html = `<div class="col-sm-6 col-12 " id="leadgeneration_${rowno}">
            <div class="form-check">
            <input id="radio-${radio_count}" name="leadgeneration" type="radio"   class="app_time">
            <label for="radio-${radio_count}" class="radio-label"><span id="leadgeneration_title_${rowno}_preview">00:00 </span> - <span id="leadgeneration_btitle_${rowno}_preview">00:00</span><span id="leadgeneration_created_at_${rowno}_preview">00:00</span></label>
            </div>
    </div>`;
        }
...
$(document).on('click', '#removeRow_leadgeneration', function() {
    var this_id = $(this).data('id');
    $(`#${this_id}`).remove();  
