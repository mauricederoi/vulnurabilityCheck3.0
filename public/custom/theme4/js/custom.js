...
$(document).ready(function() {
    ...
    //   share modal
	  ...
	  $('.make-contact-modal-toggle1').on('click', function(e) {
        $('.theme-modal1.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
		
      });
	  $('.make-contact-modal-toggle2').on('click', function(e) {
        $('.theme-modal2.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle3').on('click', function(e) {
        $('.theme-modal3.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle4').on('click', function(e) {
        $('.theme-modal4.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle5').on('click', function(e) {
        $('.theme-modal5.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle6').on('click', function(e) {
        $('.theme-modal6.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle7').on('click', function(e) {
        $('.theme-modal7.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle8').on('click', function(e) {
        $('.theme-modal8.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle9').on('click', function(e) {
        $('.theme-modal9.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle10').on('click', function(e) {
        $('.theme-modal10.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle11').on('click', function(e) {
        $('.theme-modal11.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle12').on('click', function(e) {
        $('.theme-modal12.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle13').on('click', function(e) {
        $('.theme-modal13.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle14').on('click', function(e) {
        $('.theme-modal14.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle15').on('click', function(e) {
        $('.theme-modal15.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle16').on('click', function(e) {
        $('.theme-modal16.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle17').on('click', function(e) {
        $('.theme-modal17.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle18').on('click', function(e) {
        $('.theme-modal18.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle19').on('click', function(e) {
        $('.theme-modal19.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
	  $('.make-contact-modal-toggle20').on('click', function(e) {
        $('.theme-modal20.contact-modal').toggleClass('active');
        $('body').toggleClass('no-scroll');
      });
});
